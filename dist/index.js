...
var _Raised2 = _interopRequireDefault(_Raised);

var _SwatchesGroup = require('./SwatchesGroup');

var _SwatchesGroup2 = _interopRequireDefault(_SwatchesGroup);

var Swatches = (function (_React$Component) {
  ...
  _createClass(Swatches, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        { style: this.props.pickerCSS },
        _react2['default'].createElement(
          _Raised2['default'],
          null,
          _react2['default'].createElement(
            'div',
            { style: this.props.overflowCSS },
            _react2['default'].createElement(
              'div',
              { style: this.props.bodyCSS, ref: 'body' },
              groups,
              _react2['default'].createElement('div', { style: this.props.clearCSS })
            )
          )
        )
      );
